...
// pushed to /messages
exports.emojify = // !!! cloud function name !!!
  functions.database // !!! service !!!
  .ref('/messages/{pushId}/text') // !!! conditions !!!
  .onWrite(event => { // !!! event handler !!!
    // Database write events include new, modified, or deleted database nodes. // All three types of events at the specific database path trigger this
    // cloud function.
    // For this function we only want to emojify new database nodes, so we'll
    // first check to exit out of the function early if this isn't a new
    // message.
